            ...
            <div class="container">
                ...
                <form action=" {{ route('telefone.salvar' , $cliente->id) }}" method = "post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name = "titulo" id="titulo" placeholder="Titulo do Telefone">
                    </div>
                    <div class="form-group">
                        <label for="telefone">Telefone</label>
                        <input type="text" class="form-control" name="telefone" id="telefone" placeholder="Nº do Telefone">
                    </div>
